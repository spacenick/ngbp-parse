module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    less: {
      build: {
        files: {
          '<%= build_dir %>/assets/compiled.css': '<%= app_files.less %>'
        }
      },
      compile: {
        files: {
  ...
  grunt.registerTask( 'build', [
    'clean', 'html2js', 'jshint', 'less:build', 'copy:index',
    // ,'concat:build_css'
  ...
  grunt.registerTask('check_bump', function(){
  ...
  grunt.registerMultiTask( 'index', 'Process index.html template', function () {
    ...
    grunt.file.copy('src/index.html', this.data.dir + '/index.html', { 
      process: function ( contents, path ) {
        var templated = grunt.template.process( contents, {
          data: {
            scripts: jsFiles,
            styles: cssFiles,
